...
_$ListItemImpl _$$ListItemImplFromJson(Map<String, dynamic> json) =>
    _$ListItemImpl(
      ...
      datetime: json['datetime'] == null
          ? null
          : fromMaybeTimestamp(json['datetime'] as Timestamp?),
      latLong: json['latLong'] == null
          ? null
          : fromJsonGeoPoint(json['latLong'] as GeoPoint?),
...
Map<String, dynamic> _$$ListItemImplToJson(_$ListItemImpl instance) =>
    <String, dynamic>{
      ...
      'info': instance.info,
      'urls': instance.urls,
      'datetime': toMaybeTimestamp(instance.datetime),
      'latLong': toJsonGeoPoint(instance.latLong),
