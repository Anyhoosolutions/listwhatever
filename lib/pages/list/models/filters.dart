...
class Filters with _$Filters {
  factory Filters({
    ...
    @Default(null) (double, double)? distance,
  ...
  bool anySelectedFilters({
    ...
    if (regularCategoryFilters != null && regularCategoryFilters!.entries.any((element) => element.value.isNotEmpty)) {
      return true;
    }
    if (dateCategoryFilters != null && dateCategoryFilters!.entries.isNotEmpty) {
      return true;
    }
    if (timeOfDayCategoryFilters != null && timeOfDayCategoryFilters!.entries.isNotEmpty) {
      return true;
    }
