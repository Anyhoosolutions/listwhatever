...
class AddListItemPage extends HookWidget {
  ...
  FormInputFieldInfo categoryField(
    ...
    return FormInputFieldInfo.twoAutoCompleteFields(
      ...
      onDelete: () {
        ...
        addListItemFormKey.currentState?.value[getCategoryId(Side.left, indexKey)] = null;
        addListItemFormKey.currentState?.value[getCategoryId(Side.right, indexKey)] = null;
      },
      isLoading: isLoading,
    );
  }
  ...
  List<FormInputFieldInfo> urlFields({
    ...
    return [
      for (final ik in urls.value.entries) urlField(ik.key, ik.value, urls: urls, isLoading: isLoading),
    ];
  }
